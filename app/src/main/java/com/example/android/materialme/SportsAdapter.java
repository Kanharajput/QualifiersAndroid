...
class SportsAdapter extends RecyclerView.Adapter<SportsAdapter.ViewHolder>  {
    ...
    SportsAdapter(Context context, ArrayList<Sport> sportsData) {
        this.mSportsData = sportsData;       // getting data
    ...
    public SportsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(mContext).
                inflate(R.layout.list_item, parent, false));     // itemView is return by inflator
    }
    ...
    public void onBindViewHolder(SportsAdapter.ViewHolder holder,
        ...
        holder.bindTo(currentSport);                 // assigning the data
    }
